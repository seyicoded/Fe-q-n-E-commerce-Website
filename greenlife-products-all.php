                                            ...
                                            <div class="w3-card-4 w3-round" style="margin: 6%;">
                                                ...
                                                <div id="content-box">
                                                    ...
                                                    <div style="width: 100%; padding: 2%;">
                                                        ...
                                                        <a href="product.php?mode=info&pid=<?php echo $r['p_id'];?>&p_name=<?php echo $r['p_name'];?>"><button class="w3-card-4 w3-btn w3-blue w3-round" style=" font-weight: bold; display: inline-block; width: 48%; ">MORE INFO</button></a>
                                                        <a href="product.php?mode=get&pid=<?php echo $r['p_id'];?>&p_name=<?php echo $r['p_name'];?>"><button class="w3-card-4 w3-btn w3-green w3-round" style=" font-weight: bold; display: inline-block; width: 48%;">GET IT NOW</button></a>
                                                    </div>
