...
<html>
    <head>
        ...
        <meta property="og:title" content="FQCI: " />
        <meta property="og:type" content="website" />
        <meta property="og:description" content="" />
        <meta property="og:image" content="" />
        <meta name="description" content="">
        <meta name="keywords" content="FQCI,Health,Doctor,">
        ...
        <div id="body" class="w3-container w3-padding-0 w3-margin-0">
            ...
            <div id="content" class="w3-container w3-padding-0 w3-margin-0">
                ...
                <div class="w3-container w3-margin">
                    ...
                    <div>
                        <h1 class="w3-center w3-text-shadow" title="" style="text-transform:uppercase;">TEST</h1>
                    </div>
                    
                    <div>
                        <img class="w3-responsive" src="" style="width: 100%; height: 600px;" alt="">
                    </div>
                    
                    <br>
                    
                    <div class="">
                        <div class="w3-center w3-large">user code goes here</div>
                        
                        <?php
                            include('prevention-against-corona-virus-cover-content.php');
